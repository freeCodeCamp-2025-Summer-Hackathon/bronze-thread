      ...
      <div v-if="product" class="max-w-7xl mx-auto p-6 ">
        ...
        <div class=" pt-10 mt-10">
          <div class="flex gap-6 border-b pb-2 mb-4 cursor-pointer text-sm">
            <span :class="[
              activeTab === 'description' ? 'font-semibold font-swap  text-black border-b-2 border-black' : 'text-gray-400',
            ]" @click="activeTab = 'description'">
              Description
            </span>
            <span :class="[
              activeTab === 'specs' ? 'font-semibold font-swap text-black border-b-2 border-black' : 'text-gray-400',
