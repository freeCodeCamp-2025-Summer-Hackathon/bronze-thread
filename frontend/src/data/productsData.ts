...
export const products: Product[] = [
  {
    ...
    specs:[
     ...
     "35mm Single-Lens Reflex (SLR) Film Camera"," 135 (35mm standard film)"," Canon FD Mount (interchangeable lenses supported)",
...
"Dimensions 141 x 87 x 47.5 mm"
  ...
  },
  {
    ...
    listed: 'Listed 2 days ago',
    specs:[
      "35mm film format", "FD lens mount", "Manual focus"
    ],
    seller: {
      name: 'John Doe',
      initials: 'JD',
